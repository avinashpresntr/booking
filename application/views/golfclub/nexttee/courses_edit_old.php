                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 form-inline dip-form-tab nopd" id="dip-grang">
                            ...
                            <div
                                id="dipRang1" <?php echo((!empty($row->range_to) || $row->range_from == 'On request') ? 'style="display:none;"' : ''); ?>>
                    ...
                    <div class="form-group">
                          ...
                          <?php echo $this->lang->line('Men'); ?><br/>
                           ...
                           <?php
                            ...
                            <?php
							 ...
							 echo form_input('handicap_men_1', set_value('handicap_men', $selectVal), 'id="dip-men_1" class="form-control" style="width:80%;display:inline-block;border: 1px solid #C5C5C5;"' . ((!is_numeric($row->handicap_men) && !empty($row->handicap_men)) ? 'readonly' : ''));
							
							echo form_input('handicap_men', set_value('handicap_men', $row->handicap_men), 'id="dip-men" class="form-control hiddenCustom" style="width:80%;display:inline-block;border: 1px solid #C5C5C5;"' . ((!is_numeric($row->handicap_men) && !empty($row->handicap_men)) ? '' : ''));
                        ...
                        <div class="col-sm-4 nopd">
                          <?php echo $this->lang->line('Women'); ?>  <br/>
							...
							echo form_input('handicap_women_1', set_value('handicap_women', $selectVal1), 'id="dip-women_1" class="form-control" style="width:85%;display:inline-block;border: 1px solid #C5C5C5;"' . ((!is_numeric($row->handicap_women) && !empty($row->handicap_women)) ? 'readonly' : ''));
							echo form_input('handicap_women', set_value('handicap_women', $row->handicap_women), 'id="dip-women"class="form-control hiddenCustom" style="width:85%;display:inline-block;border: 1px solid #C5C5C5;"' . ((!is_numeric($row->handicap_women) && !empty($row->handicap_women)) ? '' : '')); ?>
                            <div class="dropdown" style="width:10%;display:inline-block;vertical-align: top;">
                                <button id="dLabel" class="btn btn-default" style="padding: 9px 5px;" type="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span
                                        class="caret"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 nopd">
                            ...
                            <div id="dipWelcomeSubOption"
                                 style="background:#eee;padding:5px;<?php if (isset($row->welcome_option) && $row->welcome_option != 'Everyday') {
                                     echo 'display:none;';
                                 } ?>">
