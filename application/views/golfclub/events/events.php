<section class="dip-dash-sec">
    ...
    <div class="row dip-form-body">
      <div class="col-sm-12">
        ...
        <div>
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <a href="<?php echo site_url('samples/Event_Calendar_Sample.xls');?>" class="btn btn-warning"><?php echo $this->lang->line('DownloadSampleFile'); ?> </a>
            </div>
          </div>
        </div>
        <?php echo form_close();?>
        <div class="row">
          <div class="col-sm-8">
            <a type="button" class="btn btn-success" href="<?php echo site_full_url('golfclub/events/edit');?>"><?php echo $this->lang->line('AddNewEvent'); ?> </a>
