  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="first_modelLabel"><?php echo $this->lang->line('RateSectionDetails_course'); ?></h4>
      </div>
      <form method="post" action="#" name='basicForm' id='basicForm'>
      <div class="modal-body">
        <!-- Item Edit Form -->
            <fieldset>
            <legend><?php echo $this->lang->line('LanguageSpecificDetails_course'); ?></legend>
              <table class="dip-lang-table table table-striped"><tbody>
                <tr>
                  <th></th>
                  <th><?php echo $this->lang->line('addnewratessection_name'); ?> </th>
                </tr>
                <?php foreach ($client->languages as $key => $value):?>
                  ...
                  <tr class="<?=$default;?>">
                    ...
                    <td><?php echo form_input('name['.$value.']','', 'class="form-control" id="dipName'.$value.'" placeholder="'.$this->lang->line('addnewratessection_name').' ('.$langs[$value].')" '.$required);?></td>
                  </tr>
                <?php endforeach; ?>
              </tbody></table>
            </fieldset>
...
<div class="modal" id="child_model" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 id="first_modelLabel"><?php echo $this->lang->line('CoursesRateDetails'); ?></h4>
      </div>
      <form method="post" action="#" name='childForm' id='childForm'>
      <div class="modal-body">
        <!-- Item Edit Form -->
            <fieldset>
            <legend><?php echo $this->lang->line('LanguageSpecificDetails_course_rate'); ?></legend>
              <table class="dip-lang-table table table-striped"><tbody>
                <tr>
                  <th></th>
                  <th><?php echo $this->lang->line('addnewrates_name_course'); ?></th>
                </tr>
                <?php foreach ($client->languages as $key => $value):?>
                  <?php
                    $default = '';
                  ...
                  <tr class="<?=$default;?>">
                    <td><i class="flag flag-<?php echo $langs[$value];?>" alt="<?php echo $langs[$value];?>"></i></td>
                    <td><?php echo form_input('descr['.$value.']','', 'class="form-control" id="dipDescr'.$value.'" placeholder="'.$this->lang->line('addnewrates_name_course').' ('.$langs[$value].')" '.$required);?></td>
