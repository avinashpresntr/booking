...
if (!defined('BASEPATH')) exit('Higher security clearance level required');
...
class Layout {
    ...
    function view($view, $data = null, $return = false) {
        ...
        $data['meta_description'] = $this->description;
        $data['sitemap_priority'] = $this->sitemap_priority;
    ...
    /**
     * Set priority for sitemap
     *
     * @param $sitemap_priority
     */
    function sitemap($sitemap_priority) {
